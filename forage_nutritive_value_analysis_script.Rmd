...
#model
model = lmer(NFC ~ poly(Day,3)*Forage + (1|Pen) + (1|Paddock/Forage), data = within(dat, Forage <- relevel(Forage, ref = "Rye")))
model = lmer(NFC ~ poly(Day,2)*Forage + (1|Pen) + (1|Paddock/Forage), data = within(dat, Forage <- relevel(Forage, ref = "Rye")))
